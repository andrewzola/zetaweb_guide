...
![&#x41F;&#x438;&#x441;&#x44C;&#x43C;&#x43E; &#x43E; &#x440;&#x435;&#x433;&#x438;&#x441;&#x442;&#x440;&#x430;&#x446;&#x438;&#x438;](../.gitbook/assets/image%20%28412%29.png)
...
Значение _**Не отправлять то же событие в течении \(минут\)**_ устанавливается с той целью, чтобы повторяющаяся ошибка не засоряла почту. 
...
Также из списка **Параметры** необходимо перетянуть **Сообщения журнала регистрации: Наименование** и **Ссылка на "Сообщения журнала регистрации \(Zeta Web\)"** в поле **Текст письма** _\(см.рисунок ниже\)_.
