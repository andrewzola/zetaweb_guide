...
{% hint style="warning" %}
Если в групп необходимо добавить все склады поставщика - достаточно указать Поставщика, при обновлении групп доступности записи в регистре добавятся по всем складам поставщика с указанным типом остатков
{% endhint %}
