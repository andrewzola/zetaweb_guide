...
_Таким образом, кросс-запись выглядит следующим образом:_\
_Артикул - Бренд (левая часть) / Кросс-артикул - Кросс-бренд (правая часть)._
...
либо вносить / загружать их в справочник "Кроссы (Zeta Web)".&#x20;

![Вид справочника "Кроссы"](<../../.gitbook/assets/image (231).png>)
...
![Варианты кроссирования](<../../.gitbook/assets/image (570).png>)
