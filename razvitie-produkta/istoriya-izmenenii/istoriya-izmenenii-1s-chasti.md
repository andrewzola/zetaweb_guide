...
- Добавлен Web-сервис "ExchangeRMM", добавлена роль "ДоступКВебСервисуРММ". При настройке интеграции с конфигурацией "Виртуальный склад 3" необходимо включить эту роль для пользователя, от имени которого настроена интерграция в виртуальном складе.
...
- Исправлена ошибка получения кроссировок брендов в http-сервисе ZetaApi в том случае, если не указан идентфикатор эталоннго бренда WSG
