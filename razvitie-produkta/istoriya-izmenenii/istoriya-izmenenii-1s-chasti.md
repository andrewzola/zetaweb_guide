...
- Добавлена функциональность избранных списков номенклатуры для пользователя сайта.

### Добавлено: ###
- Для пользователя на сайте появилась возможность создавать и редактировать списки избранной номенклатуры.
