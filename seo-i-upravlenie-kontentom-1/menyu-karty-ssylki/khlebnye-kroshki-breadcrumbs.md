...
* [SEO. Хлебные крошки](khlebnye-kroshki-breadcrumbs.md)
* [Автокаталог. Текущий автомобиль](khlebnye-kroshki-breadcrumbs.md) - для страниц, на которых используются контролы из группы [Поиск. Автокаталог](khlebnye-kroshki-breadcrumbs.md)
* [Laximo. Этапы 1, 2, 3, 4. Текущее состояние поиска](khlebnye-kroshki-breadcrumbs.md) - для страниц, на которых используются контролы из группы [Laximo](khlebnye-kroshki-breadcrumbs.md)

Для отображения хлебных крошек необходимо добавить контрол на страницу и выбрать необходимые параметры контрола:

![](../../.gitbook/assets/image%20%28467%29.png)

Хлебные крошки, как и [URL страницы](../seo/formirovanie-url-zeta-web.md), создаются по-разному в зависимости от используемых [контролов](../../tekhnicheskaya-dokumentaciya-1/kontroly.md) на текущей странице.
...
* Скрывать из карты сайта - если мы не хотим, чтобы ссылка на эту страницу генерировалась контролом [карта сайта](khlebnye-kroshki-breadcrumbs.md).
...
Для всех контролов, кроме Laximo и Поиск. Автокаталог, используется общий контрол [SEO. Хлебные крошки](khlebnye-kroshki-breadcrumbs.md).

Рассмотрим на примере использования контрола [Поиск. Каталог товаров](khlebnye-kroshki-breadcrumbs.md). На страницу _catalog_ добавлен соответствующий контрол. Для самой страницы _catalog_ хлебные крошки [статической страницы](khlebnye-kroshki-breadcrumbs.md#khlebnye-kroshki-staticheskikh-stranic).
...
{% page-ref page="../../faq-1/kak-skryt-gruppu-kataloga-iz-khlebnykh-kroshek.md" %}

{% page-ref page="../../faq-1/gde-nastroit-stranicu-kataloga-dlya-khlebnykh-kroshek.md" %}
