...
* [Поиск. Поиск товаров \(уточнение артикула и бренда товара\)](zeta-veb-servisy.md)
* [Поиск. Проценка \(цены и наличие товаров\)](zeta-veb-servisy.md)
* [Поиск. Аналоги товара v2 \(цены и наличие товаров\)](zeta-veb-servisy.md)
...
Ограничение робота поисковых систем можно сделать с использованием переменных и доступности по ролям, закрыв доступ Анонимному пользователю \(т.к. робот поисковой системы для нас обычный анонимный пользователь сайта\). Рассмотрим на примере страницы уточнения бренда \(реализовано в типовом дизайен\), на которой используется контрол [Поиск. Поиск товаров \(уточнение артикула и бренда товара\)](zeta-veb-servisy.md).
